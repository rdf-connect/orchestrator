...
class RunnerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.load = channel.unary_unary(
            "/rdfc.Runner/load",
            request_serializer=intermediate__pb2.IRStage.SerializeToString,
...
def add_RunnerServicer_to_server(servicer, server):
    rpc_method_handlers = {
        "load": grpc.unary_unary_rpc_method_handler(
            servicer.load,
            request_deserializer=intermediate__pb2.IRStage.FromString,
...
class Runner(object):
    ...
    def load(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            "/rdfc.Runner/load",
            intermediate__pb2.IRStage.SerializeToString,
