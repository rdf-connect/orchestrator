...
/**
 * A custom file manager which stores compiled classes in memory and does not require the need to
 * write to disk.
 */
class MemoryFileManager(fileManager: JavaFileManager) :
  ...
  override fun getJavaFileForOutput(
    ...
    val uriString = "string:///" + className.replace('.', '/') + kind.extension
